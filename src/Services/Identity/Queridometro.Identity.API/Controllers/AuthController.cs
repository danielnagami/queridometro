...
using Queridometro.Identity.API.Models;
...
namespace Queridometro.Identity.API.Controllers
{
    [Route("api/identity")]
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Login(UserLogin userLogin)
        {
            ...
            {
                AddProcessError("User blocked temporarily for enough invalid tries.");
                return CustomResponse();
            }

            AddProcessError("User and/or password invalid(s)");
            return CustomResponse();
        }
